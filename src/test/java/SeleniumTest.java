...
public class SeleniumTest {
    ...
    private File findHtmlFile() {
        String[] possibleHtmlPaths = {
            "src/main/IfStatement.html",
            "IfStatement.html",
            "src/test/resources/IfStatement.html",
            "test-resources/IfStatement.html",
            "src/main/resources/IfStatement.html"
        };
        ...
        throw new RuntimeException("Could not find IfStatement.html in any expected location: " + 
